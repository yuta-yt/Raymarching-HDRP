            ...
            )
{
    ...
    float3 pos = GetRayOrigin(input.positionRWS, input.isFrontFace);

    DistanceFunctionSurfaceData surface = Trace(pos, ray, GBUFFER_MARCHING_ITERATION, MARCHING_ADAPTIVE_EPS_BASE);
